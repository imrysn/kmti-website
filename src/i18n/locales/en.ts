const en = {
  ...
  home: {
    ...
    services: {
      title: "OUR SERVICES",
      subtitle: "Comprehensive engineering solutions tailored to your needs, powered by cutting-edge technology and decades of expertise.",
      items: {
        "3d": {
          title: "3D MODELING",
  ...
  about: {
    hero: {
      title: "Who We Are",
      subtitle: "Driven by Precision, Built with Passion",
      description: "At Kusakabe & Maeno Technologies Inc., we combine Japanese engineering excellence and Filipino craftsmanship to deliver reliable and innovative industrial solutions."
    },
    company: {
      title: "ABOUT OUR COMPANY",
      para1: "Established through the collaboration of Kusakabe Electric & Machinery Co., Ltd, Next Engineering Co., Ltd. and Maeno Giken Inc., we bring together decades of experience.",
      para2: "Our mission is to deliver total engineering solutions, from design and prototyping to manufacturing, ensuring precision and excellence.",
    ...
    management: {
      ...
      see_less: "See Less",
      roles: {
        accounting: "ACCOUNTING / ADMIN MANAGER",
    ...
    cta: {
      title: "Building Innovation, Together."
    }
  },
  ...
  services: {
    ...
    modal: {
      ...
      "2d_section": {
        s2: { title: "2D DETAIL", desc: "" },
        s3: { title: "QUALITY CHECKING", desc: "After detailing, the design will run through series of checking and correction making sure that the design is precise and the chance of error is close to zero. When the design is already checked and final, we will send it to the client for confirmation." },
        s4: { title: "DESIGN QUALIFICATIONS", desc: "If there's still suggestions or if ever the client change their mind in some aspect of the design, further modifications will be applied to the design to meet their desired outcome." }
      }
    },
    items: {
      "3d": {
    ...
    footer_cta: {
      title: "Have a project in mind? Let's discuss how we can bring it to life"
    }
  },
  ...
  projects: {
    ...
    modal_items: {
      ...
      shear: {
        ...
        category: "MECHANICAL > TUBE",
        description: "Shear and end welders crop the tail and nose of each coil. The two coil ends are then aligned and the joint welded using TIG, MIG or MAG depending on the materials and thickness being welded. Single and twin torch versions are available.",
        ...
        specification: "A range of Shear end welders can be supplied, from small semi conductor systems to larg fully automatic systems."
      },
      uncoiler: {
      ...
      leveler: {
        ...
        category: "MECHANICAL > TUBE",
        description: "Leveling machines are used to level metal strips in throughput, e.g. In a cut-to-length line or to level single metal sheets of parts.",
        application: "",
        advantages: ""
      },
      transfer_table: {
    ...
    viewer: {
      ...
      camera: {
        ...
        front: "Front",
        front_title: "Front View",
        back: "Back",
        back_title: "Back View",
        left: "Left",
        left_title: "Left View",
        right: "Right",
        right_title: "Right View",
        top: "Top",
        top_title: "Top View",
        bottom: "Bottom",
        bottom_title: "Bottom View"
      },
      controls: {
  ...
  contact: {
    hero: {
      title: "Need help or have a specific inquiry?",
      description: "You can reach our team directly through the options below - whether it's about our services, business inquiries, or career opportunities."
    },
    options: {
      email: { title: "GENERAL INQUIRIES", btn: "SEND EMAIL" },
      career: { title: "CAREER APPLICATION", desc: "Apply through LinkedIn", btn: "VISIT CAREERS" },
      visit: { title: "OFFICE VISIT", desc: "View Map & Directions", btn: "OPEN IN GOOGLE MAPS" }
    },
    divider: { text: "OR", desc: "Chat with our AI Assistant Anytime" },
    chat: {
      title_main: "CHAT WITH US",
      title_highlight: "ANYTIME",
  ...
  chatbot_card: {
    ...
    body: {
      greeting: "Hi there! I'm KMTI Assistant 👋 How can I help you today?",
      hr_message: "Interested in joining us? Chat with our HR team on Facebook.",
