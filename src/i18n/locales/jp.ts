const jp = {
  ...
  home: {
    ...
    projects: {
      ...
      items: {
        ...
        vertical: { title: "垂直ルーパー", desc: "垂直ルーパーは、水平テーブル上にストリップ材を貯蔵します。スペースが許す場所では、この方法は表面損傷を引き起こすことなく最も効率的で費用対効果の高い貯蔵を提供します。", cat: "機械 > チューブ" },
    ...
    about: {
      title: "当社について",
      desc: "日下部前野テック株式会社、精密設計・製作・組立を専門とする信頼のエンジニアリングパートナーです。長年の業界経験と、日下部電機株式会社、ネクストエンジニアリング株式会社、前野技研株式会社との強力なパートナーシップを活かし、クライアントのニーズに応じた高品質なエンジニアリングソリューションを提供します。当社の熟練したチームスタッフは、革新・技術・専門知識を融合させ、<br /> アイデアを効率的で信頼性の高い実用的な設計に変換します。正確性、品質、顧客満足へのこだわりを大切にし、精密さをもってお客様のビジョンを形にします。",
      link: "当社について詳しく知る"
    }
  },
  ...
  contact: {
    ...
    chat: {
      ...
      features: {
        f1: { title: "24/7 即時回答", text: "当社のサービス、キャリア・応募、各種手続きに関するよくある質問に、<br />迅速にお答えします。" },
