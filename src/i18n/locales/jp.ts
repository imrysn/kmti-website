const jp = {
  ...
  home: {
    ...
    projects: {
      title: "ビジョンを現実に",
      subtitle: "貴社のアイデアが当社の精密設計により具現化されたエンジニアリングソリューションの様子をご覧ください。",
      items: {
  ...
  about: {
    ...
    history: {
      ...
      milestones: {
        ...
        item_2017: { year: "2017", title: "塗装ラインプロジェクト", description: "日下部電機、前野技研「との協力により、塗装ラインの搬送装置および積載装置を設計・製作。試組立から実機試験運転までを実施しました。" },
