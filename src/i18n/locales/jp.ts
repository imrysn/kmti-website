const jp = {
  ...
  about: {
    hero: {
      ...
      description: "日下部前野テック株式会社、日本の卓越したエンジニアリング技術とフィリピン人技術者の高い技能を\n融合させ、信頼性の高い革新的な産業ソリューションを提供しています。"
    },
    company: {
      title: "当社について",
      para1: "日下部電機株式会社、ネクストエンジニアリング株式会社、前野技研株式会社の協力により設立された当社は、長年にわたるエンジニアリング、製作、機械設計の経験を結集しています。",
    ...
    history: {
      ...
      milestones: {
        ...
        item2: { year: "2014", title: "戦略的パートナーシップ", description: "日下部前野株式会社（KEMCO）および前野技研株式会社（MGK）と重要なパートナーシップを締結しました。" },
