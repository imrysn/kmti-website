      ...
      <div className="chatbot-card-body">
        ...
        <div className="chatbot-card-message-bubble">
          ...
          <div className="chatbot-card-message-content">
            <p className="chatbot-card-message-text-content">
        ...
        <div className="chatbot-card-message-bubble">
          ...
          <div className="chatbot-card-message-content">
            <p className="chatbot-card-message-text-content">
              Got product or service inquiries? Message our <br /> support team on LINE.
            </p>
            <div
              className="chatbot-card-line-button"
              onClick={onLineClick}
            >
              <img src={lineIcon} alt="LINE" className="chatbot-card-line-button-icon" />
              <span className="chatbot-card-line-button-text">Message us on LINE</span>
            </div>
          </div>
        </div>
        ...
        <div className="chatbot-card-message-bubble">
          ...
          <div className="chatbot-card-message-content">
            ...
            <div
              className="chatbot-card-facebook-button"
              onClick={onFacebookClick}
            >
              <img src={facebookIcon} alt="Facebook" className="chatbot-card-facebook-button-icon" />
              <span className="chatbot-card-facebook-button-text">Chat us on Facebook</span>
            </div>
          </div>
        </div>
      </div>
