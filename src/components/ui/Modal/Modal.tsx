...
const assemblyImage3 = getAssetUrl('service_detail_image/assmebly3mpdal.webp'); // Keeping typo in filename from original
...
const ourStoryPhoto = getAssetUrl('about_page/ourstoryImage.webp');
...
const louieImage = getAssetUrl('management/louie.webp');
const kerbyImage = getAssetUrl('management/kerby.webp');
const kissImage = getAssetUrl('management/kiss.webp');
const lorieImage = getAssetUrl('management/lorie.webp');
...
const transferTableImage = getAssetUrl('image3D/transfer-table.webp');
const bundleSeparatorImage = getAssetUrl('image3D/bundle-separator.webp');
const pipeDryingImage = getAssetUrl('image3D/pipe-drying.webp');
const pipeBundlingImage = getAssetUrl('image3D/pipe-bundling.webp');
const productImage = getAssetUrl('image3D/product-storage.webp');
const productStorageImage = getAssetUrl('image3D/product-storage-FS.webp');
const finishingImage = getAssetUrl('image3D/finishing.webp');
const finishingLineImage = getAssetUrl('image3D/finishingLine.webp');
const airBlowImage = getAssetUrl('image3D/air-blow.webp');
const transferLifterImage = getAssetUrl('image3D/transfer-table-lifter.webp');
